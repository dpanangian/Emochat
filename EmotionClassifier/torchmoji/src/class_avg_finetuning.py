...
from torchmoji.src.global_variables import (
    FINETUNING_METHODS,
    WEIGHTS_DIR)
from torchmoji.src.finetuning import (
    freeze_layers,
    get_data_loader,
    fit_model,
    train_by_chain_thaw,
...
def class_avg_finetune(model, texts, labels, nb_classes, batch_size,
    ...
    # Arguments:
        ...
        method: Finetuning method to be used. For available methods, see
            ...
            should be defined accordingly (see docstring for torchmoji.src_transfer())
    ...
    checkpoint_path = '{}/torchmoji.src-checkpoint-{}.bin' \
                      .format(WEIGHTS_DIR, str(uuid.uuid4()))

    f1_init_path = '{}/torchmoji.src-f1-init-{}.bin' \
                   .format(WEIGHTS_DIR, str(uuid.uuid4()))
